...
#include <memory>
#include "../ribbon/src/styles/QtnRibbonStyle.h"
...
QT_MOC_LITERAL(1, 20, 17) // "activeTabAccented"

    },
    "Qtitan::RibbonStyle\0activeTabAccented"
};
...
void Qtitan::RibbonStyle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RibbonStyle *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->isActiveTabAccented(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setActiveTabAccented(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
