...
#include <memory>
#include "../colorRect/XColorMaster.h"
...
QT_MOC_LITERAL(1, 13, 18), // "signalColorChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 5), // "color"
QT_MOC_LITERAL(4, 39, 11) // "ChangeColor"

    },
    "XColorMaster\0signalColorChanged\0\0color\0"
    "ChangeColor"
};
...
void XColorMaster::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<XColorMaster *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalColorChanged((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        ...
        {
            using _t = void (XColorMaster::*)(QColor );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&XColorMaster::signalColorChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject XColorMaster::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_XColorMaster.data,
    qt_meta_data_XColorMaster,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void XColorMaster::signalColorChanged(QColor _t1)
{
